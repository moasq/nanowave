...
func TestBuildPromptsContainsSections(t *testing.T) {
	...
	appendPrompt, userMsg, err := p.buildPrompts("", "TestApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
...
func TestBuildPromptsWithPermissions(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "CamApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestBuildPromptsWithExtensions(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "WidgetApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestBuildPromptsMultiPlatform(t *testing.T) {
	...
	_, userMsg, err := p.buildPrompts("", "MultiApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestBuildPromptsAppearanceDark(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "DarkApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestBuildPromptsAppearanceLight(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "LightApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestBuildPromptsAppearanceAdaptive(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "AdaptApp", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestSPMScenarioPhotoGalleryApp(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "Pictura", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestSPMScenarioCodeNotesApp(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "DevNotes", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestSPMScenarioMusicVisualizerApp(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "SoundWave", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestSPMScenarioSocialChatApp(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "Chattr", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
...
func TestSPMScenarioRecipeTagsApp(t *testing.T) {
	...
	appendPrompt, _, err := p.buildPrompts("", "Yummly", "", analysis, plan, false, ActionContext{})
	if err != nil {
		t.Fatalf("buildPrompts() error: %v", err)
	}
