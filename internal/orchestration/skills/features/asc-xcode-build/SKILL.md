...
- If a `project.yml` exists, run `xcodegen generate` before building to sync build settings

## iOS Build Flow

### 0. Regenerate project (XcodeGen)
If `project.yml` exists in the project directory:
```bash
xcodegen generate
```
