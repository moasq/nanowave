---
name: "swiftui"
description: "SwiftUI best practices for views, state management, animations, forms, lists, scroll, performance, and modern APIs. Use when writing ANY SwiftUI view, creating UI components, managing @State/@Observable, or building layouts. Triggers: View, body, @State, @Observable, NavigationStack, List, Form, animation, withAnimation, .task."
---
# SwiftUI Patterns

Read the relevant guide for your current task:
- [animations.md](reference/animations.md) — timing, transitions, keyframes
- [forms.md](reference/forms.md) — form layout, validation, input controls
- [lists.md](reference/lists.md) — list patterns, ForEach, swipe actions
- [scroll.md](reference/scroll.md) — ScrollView, paging, parallax
